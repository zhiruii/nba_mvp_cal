...
from reg_stats_scraping import reg_stats_table
from adv_stats_scraping import advanced_stats_table
from actual_mvp_race import historical_MVP_race_table
import pandas as pd
...
def pre_score_table(year):
    ...
    #barely made the mark are insignificant to our mvp candidates shortlist.
